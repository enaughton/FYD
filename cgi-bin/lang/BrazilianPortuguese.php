...
// Configurações Para Português do Brasil
// Script traduzido para o Português do Brasil por Flávio Araújo
...
define('DDFM_INVALIDEMAIL', 'Endereço de email inv&aacute;lido para');
