...
define('DDFM_MISSINGFIELD', 'Prüfen Sie folgende Angaben auf Richtigkeit / Vollst&auml;ndigkeit:');
...
define('DDFM_GDERROR', '<p>GD wurde nicht gefunden! GD  wird für die Generierung der Zeichencode-Abfrage ben&ouml;tigt.</p>');
